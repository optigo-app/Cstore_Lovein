...
export default function TestimonialSection() {
  ...
  let demoJson = [
    ...
    {
      images: s5,
      discrip: "I got a Radiant Cut Diamond Ring with a hidden Halo setting and it is beyond gorgeous. The way of dealing is really captivating unlike the traditional jewelry stores plus I am really satisfied with the product too.",
      auther: 'Deephues'
    },
    {
      images: s6,
