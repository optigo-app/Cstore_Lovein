    ...
    <div>
      ...
      <div className='articleDeatilMain'>
        <div className='articleDetail'>
          ...
          <div style={{ display: 'flex' }}>
            <div className='articleDeatilSec'>
              <p>The season is when we finally adorn ourselves with the finest jewelry. So get your favourite pair of earrings, most elegant pendant and classis bands and pay absolutely 0% making charges.
                <br />
                <br />
