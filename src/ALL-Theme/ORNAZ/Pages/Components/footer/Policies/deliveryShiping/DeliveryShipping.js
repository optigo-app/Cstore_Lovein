    ...
    <div>
      ...
      <div style={{paddingInline : '22%' ,marginBottom : '80px'}}>
        <div>
          ...
          <p>When you have placed your order, the exciting part of making your jewelry begins. Once completed, we will contact you to inform you that the item is ready for dispatch</p>
        </div>
        <div>
          ...
          <p>All our items are delivered in discrete shipment packaging with no indication of what is inside. However, International orders that cross country borders comply with local rules about declaration of value. The actual jewelry is contained in a luxurious gift box with protective outer packaging.</p>
