        ...
        <div style={{ width: '1100px'}}>
          ...
          <div style={{ display: 'flex', flexDirection: 'row',}}>
            <div className='detailSection'>
              <p style={{fontSize : '16px'}}>Although we have an extensive selection of Engagement Rings to choose from, if you have any specific design in your mind, that is when our custom fabrication comes in. Custom creating a piece of jewelry is often perceived as complicated and expensive, but that is not the case here as we provide this service complimentary while taking care of turning your imagination into reality . We will take the time to explain the process of custom creation.</p>
