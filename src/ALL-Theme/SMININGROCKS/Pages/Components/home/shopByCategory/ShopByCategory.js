...
// import shop3 from '../../../assets/Lovein/c3.jpg'
// import shop4 from '../../../assets/Lovein/c4.jpg'
import { Colors } from '../../../../lib/consts/Colors'
import { storImagePath } from '../../../../Utils/globalFunctions/GlobalFunction'
console.log('store init image');
        ...
        <div style={{
          ...
          <div className='shopByCategoryBox1Main'>
            <div className='shopByCategoryBox'>
              ...
              <p style={{ fontWeight: 500, color: Colors.fontColor, textAlign: 'center', marginTop: '10px' }}>RINGS</p>
            </div>
            <div className='shopByCategoryBox'>
              ...
              <p style={{ fontWeight: 500, color: Colors.fontColor, textAlign: 'center', marginTop: '10px' }}>EARRINGS</p>
            </div>
          </div>
          <div className='shopByCategoryBox1Main'>
            <div className='shopByCategoryBox'>
              ...
              <p style={{ fontWeight: 500, color: Colors.fontColor, textAlign: 'center', marginTop: '10px' }}>BRACELETS</p>
            </div>
            <div className='shopByCategoryBox'>
              ...
              <p style={{ fontWeight: 500, color: Colors.fontColor, textAlign: 'center', marginTop: '10px' }}>PENDANT</p>
            </div>
          </div>
          <div className='shopByCategoryBox2Main'>
            <div className='shopByCategoryBox'>
              ...
              <p style={{ fontWeight: 500, color: Colors.fontColor, textAlign: 'center', marginTop: '10px' }}>NECKLACE</p>
            </div >
          </div>
        </div>
      </div>
