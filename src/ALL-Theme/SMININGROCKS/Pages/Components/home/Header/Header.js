...
// import titleImg from "../../../assets/logo-1.png";
import titleImg from "../../../assets/LoveInLogo.png";
    ...
    <>
          ...
          <div className="smlingDraweOverlay">
            ...
            <div className="smlingDraweOverlayMain">
              ...
              {islogin === 'true' && (<div className="drawrTitlediv" style={{ marginTop: "20px" }}>
                ...
                >
                  COLLECTIONS<span>{isOpenCollection ? "-" : "+"}</span>
                </p>
      ...
      <div className="sminingHeaderWeb ">
        <div className="Smining-Top-Header ">
          ...
          >
            <a href="/">
              <img src={titleImg} className="headerLogoMainImage" />
            </a>
          </div>
          <div
            style={{
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'row', gap: '50px' }}>
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                <span style={{ fontSize: '13px', fontFamily: 'TT Commons, sans-serif', letterSpacing: 1, fontWeight: 600 }}>FINE JEWELLERY</span>
        ...
        >
          <div className="Smining-Top-Header-fixed">
            ...
            <div
              ...
              className="thirdMainDivFixedHeader"
            >
              <ul className="nav-ul-fixed">
                <li
                  className="nav-li-smining-fixed"
