        ...
        <div>
                ...
                <div className='footerIconMain'>
                    <div className='footerFace'>
                        <a href='https://www.facebook.com/people/Love-in-Diamonds/100077999103991/?mibextid=LQQJ4d&rdid=pMV3Z0FSyICWnuhV&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2FUyob7trhQBjGvXnA%2F%3Fmibextid%3DLQQJ4d'>
                            ...
                            <img src={`${storImagePath()}/images/HomePage/SocialMediaIcon/faceBook.png`} className='iconeImges'/>
                        </a>
                    </div>
                    <div className='footerTwi'>
                        <a href='https://in.linkedin.com/company/love-in-diamonds'>
                            {/* <FaTwitter style={{ color: '#7d7f85' }} /> */}
                            <img src={`${storImagePath()}/images/HomePage/SocialMediaIcon/linkedin.png`} className='iconeImges'/>
                        </a>
                    </div>
                    <div className='footerInsta'>
                        <a href='https://www.instagram.com/loveindiamonds/?igsh=MTVic2NuM2o2NW01Yw%3D%3D&utm_source=qr'>
                            ...
                            <img src={`${storImagePath()}/images/HomePage/SocialMediaIcon/instagram.png`} className='iconeImges'/>
                        </a>
                    </div>
                    <div className='footerYou'>
                        <a href='https://in.pinterest.com/LoveinDiamonds/?invite_code=9eeee2e007154baabac791e34e75bdb2'>
                            ...
                            <img src={`${storImagePath()}/images/HomePage/SocialMediaIcon/pin.png`} className='iconeImges'/>
                        </a>
                    </div>
                </div>
            ...
            <div style={{ textAlign: 'center' }}>
                ...
                <div className='footerIconeImageMain' style={{ display: 'flex', justifyContent: 'center', gap: '40px', paddingBottom: '12px' }}>
                    <img src={`${storImagePath()}/images/HomePage/CompanyData/AssociatedCompanyImg1.png`} className='footerIconeImages' style={{ height: '80px', cursor: 'pointer', paddingBlock: '10px' }} />
                    <img src={`${storImagePath()}/images/HomePage/CompanyData/AssociatedCompanyImg2.png`} className='footerIconeImages' style={{ height: '80px', cursor: 'pointer', paddingBlock: '10px' }} />
                    <img src={`${storImagePath()}/images/HomePage/CompanyData/AssociatedCompanyImg3.png`} className='footerIconeImages' style={{ height: '80px', cursor: 'pointer', paddingBlock: '10px' }} />
                    <img src={`${storImagePath()}/images/HomePage/CompanyData/AssociatedCompanyImg4.png`} className='footerIconeImages' style={{ height: '80px', cursor: 'pointer', paddingBlock: '10px' }} />
                    <img src={`${storImagePath()}/images/HomePage/CompanyData/AssociatedCompanyImg5.png`} className='footerIconeImages' style={{ height: '80px', cursor: 'pointer', paddingBlock: '10px' }} />
                </div>
            </div>
