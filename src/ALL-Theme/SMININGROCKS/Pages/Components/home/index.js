...
export default function Home() {
  ...
  useEffect(() => {
    ...
    //     domain:  (window.location.hostname === 'localhost' || window.location.hostname === 'zen') ? 'cstore.orail.co.in' : window.location.hostname,
    //     version: 'V6',
    //     sp: "1"
    //     // domain: 'zen',
    //   };
...
let youtubeVideoUrl = "https://www.youtube.com/embed/DkVfi2ApzwQ?autoplay=1&controls=0&mute=1&loop=1&playlist=DkVfi2ApzwQ"
  return (
    <div className='paddingTopMobileSet' style={{ background: '#efe5ff', paddingTop: '110px' }}>
