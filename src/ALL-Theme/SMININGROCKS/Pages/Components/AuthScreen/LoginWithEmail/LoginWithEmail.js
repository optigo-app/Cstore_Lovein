...
export default function LoginWithEmail() {
    ...
    return (
        <div className='paddingTopMobileSet' style={{ backgroundColor: '#efe5ff', paddingTop: '110px' }}>
            <ToastContainer />
            {isLoading && (
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                        <TextField
                            ...
                            InputProps={{
                                ...
                                sx: { '& fieldset': { borderColor: 'rgb(95,73,122)' } },
                                endAdornment: (
                            ...
                            InputLabelProps={{
                                sx: { color: 'rgb(95,73,122)' }
                            }}
                        />

                        <button className='submitBtnForgot' style={{color:'rgb(95,73,122)', background:'rgb(239,229,255)'}} onClick={handleSubmit}>Login</button>
                        <Button style={{ marginTop: '10px', color: 'rgb(95,73,122)' }} onClick={() => navigation('/LoginOption')}>CANCEL</Button>

                        <button type='submit' className='SmilingLoginCodeBtn' style={{color:'rgb(95,73,122)', background:'rgb(239,229,255)'}} onClick={handleNavigation}>Login With a Code instead on email</button>
                        <p style={{ textAlign: 'center', color:'rgb(95,73,122)' }}>Go passwordless! we'll send you an email.</p>

                        <p style={{ color: 'rgb(95,73,122)', cursor: 'pointer' }} onClick={handleForgotPassword}>Forgot Password ?</p>
                    </div>
                    <Footer />
                </div>
            </div>
            <div style={{ display: 'flex', justifyContent: 'center', paddingBlock: '30px' }}>
                <p style={{ margin: '0px', fontWeight: 500, width: '100px', color: 'rgb(95,73,122)', cursor: 'pointer' }} onClick={() => window.scrollTo(0, 0)}>BACK TO TOP</p>
            </div>
        </div>
    );
}
