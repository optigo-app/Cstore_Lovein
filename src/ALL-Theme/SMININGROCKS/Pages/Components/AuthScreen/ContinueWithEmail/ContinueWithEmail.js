            ...
            <div style={{ backgroundColor: '#efe5ff' }}>
                <div className='smling-forgot-main'>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                        ...
                        <button type='submit' className='submitBtnForgot' style={{color:'rgb(95,73,122)', background:'rgb(239,229,255)'}} onClick={handleSubmit}>SUBMIT</button>
                        <Button className='cancelBtn' style={{ marginTop: '10px', color: 'rgb(95,73,122)' }} onClick={() => navigation('/LoginOption')}>CANCEL</Button>
                    </div>
                    <Footer />
                </div>
            </div>
