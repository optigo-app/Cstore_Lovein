...
export default function Register() {
  ...
  return (
    <div className='paddingTopMobileSet' style={{ backgroundColor: '#efe5ff', paddingTop: '110px' }}>
      ...
      <div style={{ backgroundColor: 'rgb(239,229,255)' }}>
        <div className='smling-register-main'>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <button className='createBtnRegister' style={{color:'rgb(95,73,122)', background:'rgb(239,229,255)'}} onClick={handleSubmit}>CREATE ACCOUNT</button>

            {/* <div style={{ display: 'flex', marginTop: '10px' }}>
              <input type='checkbox' />
              <p style={{ margin: '5px' }}>Subscribe to our newsletter</p>
            </div> */}
            <Button className='cancelBtn' style={{ marginTop: '10px', color: 'rgb(95,73,122)' }} onClick={() => navigation('/LoginOption')}>BACK</Button>
          </div>
          <Footer />
        </div>
      </div>
